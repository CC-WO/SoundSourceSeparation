...
- maximize：目的関数＋γパラメータの値のとりやすさ
- subeject to：パラメータが満たさないといけない製薬
...
#### 4.3 ラグランジュ未定乗数法による制約付き最適化問題

- ラグランジュの未定乗数法

#### 4.4 確率・統計的なフレームワークに基づくパラメータ最適化

- ガウス分布

#### 4.5 MM(Maximization-Majorization)法に基づくパラメータ最適化
